    ...
    */
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          user_data_dir: { type: "string", description: "用户数据目录路径，提供此参数时将使用持久化上下文启动浏览器" },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          removeComments: { type: "boolean", description: "Remove all HTML comments (default: true)" },
          removeStyles: { type: "boolean", description: "Remove all style tags from the HTML (default: true)" },
