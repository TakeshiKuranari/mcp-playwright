import { ClickTool,ClickAndSwitchTabTool, FillTool, SelectTool, HoverTool, EvaluateTool, IframeClickTool, UploadFileTool, GetTextTool } from '../../../tools/browser/interaction.js';
