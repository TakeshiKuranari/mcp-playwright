...
- **Inputs:**
  ...
  - **`removeScripts`** *(boolean, optional, default: true)*:  
    Remove all script tags from the HTML to reduce noise.
  - **`removeComments`** *(boolean, optional, default: true)*:  
    Remove all HTML comments to clean up the output.
  - **`removeStyles`** *(boolean, optional, default: true)*:  
    Remove all style tags from the HTML.
  - **`removeMeta`** *(boolean, optional, default: true)*:  
  ...
  - **`cleanHtml`** *(boolean, optional, default: true)*:  
